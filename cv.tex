%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Friggeri-Modified CV 
% Version 1.1 (10/04/2015)
%
% This document is based on a template that was originally created
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\documentclass[]{friggos-cv} % Add 'print' as an option into the square bracket to remove colors from this template for printing
...
\begin{aside2}
    \section{logiciels informatiques}
	    ...
	    \vspace{10pt}%
	    {\addfontfeature{Color=lightgray}Bureautique}%
	    \vspace{-8pt}
	    ...
	    \end{tabular}    
	    \vspace{-6pt}%
	    {\addfontfeature{Color=lightgray}Design Graphique}%
	    \vspace{-6pt}
	    \begin{tabular}{@{}m{2.4cm}m{2.1cm}@{}}
	    ...
	    \end{tabular}
	    \vspace{-6pt}%
	    {\addfontfeature{Color=lightgray}Systèmes d'Exploitation}%
	    \vspace{-6pt}
	    \begin{tabular}{@{}m{2.4cm}m{2.1cm}@{}}
	    ...
	    \end{tabular}    
	    \vspace{-6pt}%
	    {\addfontfeature{Color=lightgray}Logiciels Spécialisés}%
	    \vspace{-6pt}
	    \begin{tabular}{@{}m{2.4cm}m{2.1cm}@{}}
